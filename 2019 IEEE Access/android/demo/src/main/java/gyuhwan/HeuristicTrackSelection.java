...
public class HeuristicTrackSelection extends BaseTrackSelection {
    ...
    public static final class Factory implements TrackSelection.Factory {
        ...
        @Override
        public HeuristicTrackSelection createTrackSelection(TrackGroup group, int... tracks) {
            return new HeuristicTrackSelection(group, tracks, bandwidthMeter, maxInitialBitrate,
     ...
     * @param bandwidthMeter Provides an estimate of the currently available bandwidth.
     */
    public HeuristicTrackSelection(TrackGroup group, int[] tracks,
     ...
     *                                          for inaccuracies in the bandwidth estimator.
     */
    public HeuristicTrackSelection(TrackGroup group, int[] tracks, BandwidthMeter bandwidthMeter,
        ...
        this.bandwidthFraction = bandwidthFraction;
        this.connection=new Connection(PlayerClock.getInstance().getVideo_idx(),PlayerClock.getInstance().getSelectKnapsackEnergyRate());
    ...
    public void updateSelectedTrack(long bufferedDurationUs) {
        ...
        Log.d("DEBUGYU-NETWORK","Select Version = "+selectedIndex);
    ...
    private int determineIdealSelectedIndex(long nowMs,int start) {
        ...
        Log.d("DEBUGYU-NETWORK"," bitrateEstimate : " + bitrateEstimate);
        Log.d("DEBUGYU-NETWORK"," maxInitialBitrate : " + maxInitialBitrate);

        long effectiveBitrate = bitrateEstimate == BandwidthMeter.NO_ESTIMATE
                ? maxInitialBitrate : (long) (bitrateEstimate * bandwidthFraction);
        Log.d("DEBUGYU-NETWORK"," effectiveBitrate : " + effectiveBitrate);
        effectiveBitrate=fakeNetwork.getConstNetworkSpeed(FAKE_NETWORK_TYPE,segmentIndex++);
        Log.d("DEBUGYU-NETWORK"," fake effectiveBitrate : " + effectiveBitrate);

        int lowestBitrateNonBlacklistedIndex = 0;
        for (int i = start; i < length; i++) {
            if (nowMs == Long.MIN_VALUE || !isBlacklisted(i, nowMs)) {
                Format format = getFormat(i);
                Log.d("DEBUGYU-NETWORK","format "+i+" Bitrate = "+format.bitrate);
        ...
        Log.w("DEBUGYU-NETWORK","Selection Index : "+lowestBitrateNonBlacklistedIndex);
