...
public class NormalAdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public static final class Factory implements TrackSelection.Factory {
        ...
        @Override
        public NormalAdaptiveTrackSelection createTrackSelection(TrackGroup group, int... tracks) {
            return new NormalAdaptiveTrackSelection(group, tracks, bandwidthMeter, maxInitialBitrate,
    ...
    private ArrayList<Integer> MaxResolutionWithSSIM;
     ...
     * @param bandwidthMeter Provides an estimate of the currently available bandwidth.
     */
    public NormalAdaptiveTrackSelection(TrackGroup group, int[] tracks,
     ...
     *                                          for inaccuracies in the bandwidth estimator.
     */
    public NormalAdaptiveTrackSelection(TrackGroup group, int[] tracks, BandwidthMeter bandwidthMeter,
    ...
    private void readMaxResolution(final String fileUrl){
    ...
    public class readThread extends Thread{
        ...
        @Override
        public void run() {
            String txtpath = "http://165.246.43.96/"+fileUrl;
            HttpClient httpClient = new DefaultHttpClient();
            HttpGet getRequest = new HttpGet(txtpath);
            MaxResolutionWithSSIM=new ArrayList<Integer>();
            try {
                ...
                if (httpResponse.getStatusLine().getStatusCode() != HttpStatus.SC_OK) {
                    ...
                    while ((line = bufferedReader.readLine()) != null) {
                        MaxResolutionWithSSIM.add(Integer.parseInt(line));
                    }
                    inputStream.close();
                }
                Log.d("DEBUGYU","Max Resolution Size : "+String.valueOf(MaxResolutionWithSSIM.size()));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public int getFrameTime(){
        int index=(int)ctime;
        index=Math.min(index,MaxResolutionWithSSIM.size()-1);
        return MaxResolutionWithSSIM.get(index)-1;
    }
    ...
    public void updateSelectedTrack(long bufferedDurationUs) {
     ...
     //   Log.d("DEBUGYU","nowMs : "+String.valueOf(nowMs));
        ...
        selectedIndex = 4-PlayerClock.getInstance().getMacro_mode_index();
