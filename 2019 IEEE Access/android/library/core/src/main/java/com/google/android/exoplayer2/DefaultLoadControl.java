...
public final class DefaultLoadControl implements LoadControl {
  ...
  public DefaultLoadControl(int minbuffer,int maxbuffer,int playback_buffer,int playback_rebuffer) {
    this(new DefaultAllocator(true, C.DEFAULT_BUFFER_SEGMENT_SIZE),minbuffer,maxbuffer, playback_buffer,
            playback_rebuffer);
  }
